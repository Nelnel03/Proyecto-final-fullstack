...
const History = () => {
    ...
    const [_activeFilter, _setActiveFilter] = useState('Todos');
    ...
    const _filteredResources = _activeFilter === 'Todos' ? _resources : _resources.filter(r => r.type.includes(_activeFilter));
